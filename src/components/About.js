          ...
          <div className="row gy-3 gy-md-4 gy-lg-0 align-items-lg-center">
            <div className="col-12 col-lg-6 col-xl-5">
              <img
                ...
                loading="lazy"
                src="https://images.unsplash.com/photo-1505548180721-c6da7b419123?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGNvdW50aW5nJTIwd29yZHxlbnwwfHwwfHx8MA%3D%3D"
                alt="Word Counting"
              />
            </div>
              ...
              <div className="row justify-content-xl-center">
                <div className="col-12 col-xl-11">
                  ...
                  <p className="lead fs-4 mb-3">
                    We are a team of language enthusiasts, developers, and productivity geeks who believe that words matter. Whether you're a student, writer, editor, or just someone who loves clarity, our Word Counter App is designed to help you write smarter and faster.
                  </p>
                  <p className="mb-5">
                    ...
                    <div className="col-12 col-md-6">
                      <div className="d-flex">
                        ...
                        <div>
                          ...
                          <p className=" mb-0">
                            Our Word Counter App is designed to help writers, students, professionals stay focused, accurate, and productive.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-12 col-md-6">
                      <div className="d-flex">
                        ...
                        <div>
                          ...
                          <p className="mb-0">
                            The Word Counter App is just one example of how we turn simple ideas into powerful tools that help users.
                          </p>
                        </div>
                      </div>
                    </div>
